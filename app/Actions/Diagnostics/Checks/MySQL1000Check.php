 ...
 * It is only a quick-and-dirty hack to narrow down the root cause of the
 * "MySQL 1000 Bug".
 * This class ONLY works with the DB dump by Serena Butler (aka Dirk Karsten).
 * The IDs are hard-coded for that DB dump.
 */
class MySQL1000Check implements DiagnosticCheckInterface
{
